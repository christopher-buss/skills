---
name: tdd
description: Test-driven development with red-green-refactor loop. Use when user wants to build features, fix bugs, mentions "tdd", wants integration tests, or implementing all new code.
---
...
Stub out the test file with the test descriptions using test.todo (without
implementation) to get user feedback on coverage before writing any code.
...
- Don't anticipate future test behavior
- Keep tests focused on observable behavior
- Commit history shows a clear progression of behavior being added
